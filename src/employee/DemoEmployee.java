...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
        ...
        emp3.whoAmI();
        // TODO To complete
        // emp3.whoAmI() // prints ["PART TIME EMPLOYEE"] because [PartTimeEmployee.whoAmI() overrides Employee.whoAmI()]
        // emp3.getHourlyRate(); // returns syntax error because [Employee does not define getHourlyRate()]
...
//         PartTimeEmployee pEmp3 = (PartTimeEmployee) emp1;
        ...
        // because [you cant cast a vague class to a specific class]

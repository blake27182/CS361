...
public class Reflection {
	...
	public void inheritanceChain(Object o) {
		...
		while ((cls = o.getClass().getSuperclass()) != null){
			...
			System.out.print(" inherits from " + cls.toString());
		}
	}
	...
	public static void main(String[] args) {
		...
		// TODO To complete
		ColoredCircle myCirc = new ColoredCircle();
		r.listMethods(myCirc);
		r.inheritanceChain(myCirc);
		r.correspondingClass(myCirc);
	}
